...
namespace LayuiLearn.Common
{
    ...
    public static class CryptTools
    {
        ...
        /// 企业工作台登录密钥字符串
        /// </summary>
        public static string ENS_PASSWORD_SECRET = "ENS_PASSWORD_SECRET";
        ...
        /// SIWap用户信息密钥字符串
        /// </summary>
        public static string SIWap_SECRET = "SIWap_SECRET";
        ...
        public static string ConvertToSHA(string oriPassword, int b)
        {
            byte[] buffer = Encoding.UTF8.GetBytes(oriPassword);
            byte[] result = { };
                ...
                case 384:
                    {
                        ...
                        result = SHA384.ComputeHash(buffer);
                        break;
                    }
                case 512:
                    {
                        SHA512CryptoServiceProvider SHA512 = new SHA512CryptoServiceProvider();
                        result = SHA512.ComputeHash(buffer);
                        break;
                    }
            }
